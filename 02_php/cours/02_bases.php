    ...
    <main class="container-fluid px-5">
        <div class="row border p-5 mt-5">
            ...
            <div class="col-sm-12">
                ...
                <p>
                    En dehors des balises PHP, il;est possible d'écrire du code HTML dans fichier ayant l'extension .php, ce qui n'est pas possible dans un fichier .html. Cela est dû au fait que les fichiers .php sont traités par le serveur en tant que code PHP et peuvent in clure des instruction PHP et HTML, tandis que les fichiers .html ne sont pas traités comme du code PHP.
                </p>
                <p>
            ...
            <div class="col-sm-12">
                ...
                <ul>
                    ...
                    <li>
                        L'instruction <span>print</span> : c'sest une instruction d'affichage. Nous pouvons y mettre du HTML.
                    </li>
                    <div class="alert alert-primary -w-50">
                        <?php
                    ...
                    <li>
                        Les instructions <span>var_dump()</span> et <span>print_r</span> : permettent d'afficher du contenu mais on s'en servira principalement pour débugger. Ces deux fonctions permettent d'analyser dans le navigateur le contenu d'une variable par exemple (nous en verrons l'utilisation plus tard)
                    </li>
                </ul>
            </div>
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                ...
                <p>Affecter une variable consiste à lui donner une valeur : lorsque vous déclarer une variable vous ne lui donnez pas de type c'set la valeur que vous lui affectez qui va determiner son type</p>
                <ul>
