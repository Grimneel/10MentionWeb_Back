...
<div class="d-flex flex-column  mt-5 p-5">
     ...
     <!-- le paramètre vider=1 pour indiquer qu'il faut vider le panier. -->
          ...
          $info='';
               ...
               if (empty($_SESSION['panier'])) { // si le panier est vide, j'affiche un message à l'utilisateur
                    echo $info = alert('votre panier est vide','warning');
               }else { // si non j'affiche le tableau avec les films stockés dans le panier
                    
               

          ?>
          <a href="?action=vider" class="btn align-self-end mb-5">Vider le panier</a>
