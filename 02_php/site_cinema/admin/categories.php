...
foreach ($_POST as $key => $value) {
     if (empty(trim($value))) {
   ...
   } else { // tousb les champs sont remplis je passe à la vérification et validations des données
        ...
        if (!isset($description) || strlen($description) < 20) {
            $info .= alert("le champs description de la catégorie n'est pas valide", "danger");
        }
        ...
        <table class="table table-dark table-bordered mt-5 " >
            ...
            ?>
                    ...
                    <tr>
                        ...
                        <td><?=substr(html_entity_decode(ucfirst($categorie['description'])), 0, 100 )  ?></td> <!-- Convertit les entités HTML à leurs caractères correspondant -->
